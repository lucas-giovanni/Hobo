...
<head>
  ...
  <title>Hobo world- Frontend Clone – Watch TV Shows Online, Watch Movies Online</title>
  <meta name="description" content="Hobo" />
  <meta name="robots" content="index, follow" />


  <link rel="stylesheet" href="../home/lib/owl.carousel.css" />
  <script src="../home/lib/jquery 3.5.0.js"></script>
  <script src="../home/lib/owl.carousel.js"></script>


  <!--main script file-->
  <script src="../home/js/main-script.js"></script>
  ...
  <link rel="stylesheet" href="../home/css/browse.css">
    ...
    <div>
      <header class="d-flex space-between flex-center flex-middle">
        <div class="nav-links d-flex flex-center flex-middle">
          <a href="/">
            <h2 class="logo logo-text red-color f-s-28 m-r-25">Hobo</h2>
            <h2 class="second-logo-text red-color f-s-28">H</h2>
          </a>
        ...
        <div class="righticons d-flex flex-end flex-middle">
          <a href="search.html"><img src="../home/images/icons/search.svg" alt="search icon"></a>
          <div class="dropdown notification">
            <img src="../home/images/icons/notification.svg" alt="notificatio icon">
            <div class="dropdown-content">
              <a href="#" class="profile-item d-flex flex-middle">
                <img src="../../home/images/icons/user2.png" alt="user profile icon" class="user-icon">
                <span>You have new notification from <span>User 123</span></span>
              </a>
              <a href="#" class="profile-item d-flex flex-middle">
                <img src="../../home/images/icons/user1.png" alt="user profile icon" class="user-icon">
                <span>You have new notification from <span>User 123</span></span>
              </a>
              <a href="#" class="profile-item d-flex flex-middle">
                <img src="../../home/images/icons/user4.png" alt="user profile icon" class="user-icon">
                <span>You have new notification from <span>User 123</span></span>
              </a>
              <a href="#" class="profile-item d-flex flex-middle">
                <img src="../../home/images/icons/user3.png" alt="user profile icon" class="user-icon">
                <span>You have new notification from <span>User 123</span></span>
              </a>
            </div>
          </div>
          ...
          <div class="dropdown">
            <img src="../home/images/icons/user-image-green.png" alt="user profile icon" class="user-icon"> <span class="profile-arrow"></span>
            ...
            <div class="dropdown-content">
              ...
              <div class="links d-flex direction-column">
                ...
                <a href="inlog.php">Sign Out of Hobo</a>
              </div>
      ...
      <div class="">
        <section id="browse-dashboard" class=" d-flex direction-column flex-start middle-align">
          <div>
            <!--trailer video-->
            <video class="hero-background-image" id="hero-video" poster="../home/images/tv-show/poster/never-have-ever-tv-show.webp">
              <source src="../home/images/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4" type="video/mp4">
          ...
          <div class="container text-container" style="z-index: 5;">
            <div class="contentlogo">
              <img src="../home/images/tv-show/poster/never-have-ever-logo.webp" alt="content logo" class="show-logo" />
            </div>
            ...
            <div class="ranking d-flex m-t-20 flex-middle">
              <svg id="top-10-badge" viewBox="0 0 28 30">
                ...
                <path
                  ...
                  fill="#FFFFFF"></path>
                <polygon fill="#FFFFFF" points="8.86676 23.9094206 8.86676 16.6651418 6.88122061 17.1783055 6.88122061 14.9266812 11.0750267 13.8558085 11.0750267 23.9094206">
                </polygon>
                <path
                ...
                <path
                  ...
                  fill="#FFFFFF"></path>
                <polygon fill="#FFFFFF" points="8.4639503 12.8342327 6.65837455 13.2666206 6.65837455 7.77862061 4.65323515 7.77862061 4.65323515 6.22012364 10.4690897 6.22012364 10.4690897 7.77862061 8.4639503 7.77862061">
                </polygon>
              </svg>
      ...
      <div class="black-background">
        ...
        <section id="mylist" class="container">
          ...
          <div class="mylist-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
            <div class="video">
              <video class="mylist-img p-r-10 p-t-10 video-item" poster="../home/images/tv-show/poster/never-have-ever-short poster.jpg">
                <source src="../home/images/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4" type="video/mp4">
                Your browser does not support the video tag.
              </video>
            ...
            <div class="video">
              <video class="mylist-img p-r-10 p-t-10 video-item" poster="../home/images/movies/we-are-the-milers-poster-little.webp">
                <source src="../home/images/movies/videos/We're the Millers - Official Trailer [HD].mp4" type="video/mp4">
                Your browser does not support the video tag.
              </video>
            ...
            <div class="video">
              <video class="mylist-img p-r-10 p-t-10 video-item" poster="../home/images/movies/extraction-poster.jpg">
                <source src="../home/images/movies/videos/Murder Mystery - Trailer - Netflix.mp4" type="video/mp4">
                Your browser does not support the video tag.
              </video>
        ...
        <section id="continue-watching" class="container p-t-40">
          <h4 class="continue-watching-heading">
            Continue watching for Lucas Royal
          </h4>
          <div class="continue-watching-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">

            <div class="video">
              <video class="mylist-img p-r-10 p-t-10 video-item" poster="../home/images/movies/horrible-bosses-middle-poster.webp">
                <source src="../home/images/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4" type="video/mp4">
                Your browser does not support the video tag.
              </video>
            ...
            <div class="video">
              <video class="mylist-img p-r-10 p-t-10 video-item" poster="../home/images/movies/kabir-singh-poster.webp">
                <source src="../home/images/tv-show/videos/Never Have I Ever - Official Trailer - Netflix_2.mp4" type="video/mp4">
                Your browser does not support the video tag.
              </video>
        ...
        <section id="romantic" class="container p-t-40">
          ...
          <div class="romantic-container d-flex flex-start flex-middle flex-no-wrap owl-carousel">
            <a href="#">
              <img src="../home/images/movies/horrible-bosses-middle-poster.webp" alt="" class="mylist-img p-r-10 p-t-10 image-size item"></a>
            <a href="#">
              <img src="../home/images/movies/kabir-singh-poster.webp" alt="" class="mylist-img p-r-10 p-t-10 image-size item"></a>
            <a href="#">
              <img src="../home/images/movies/extraction-poster.jpg" alt="" class="mylist-img p-r-10 p-t-10 image-size item"></a>
            <a href="#">
              <img src="../home/images/tv-show/poster/never-have-ever-short poster.jpg" alt="" class="mylist-img p-r-10 p-t-10 image-size item"></a>
            <a href="#">
              <img src="../home/images/movies/we-are-the-milers-poster-little.webp" alt="" class="mylist-img p-r-10 p-t-10 image-size item"></a>
        ...
        <section class="big-section d-flex flex-start container">
          <img src="../home/images/tv-show/poster/sex-education.webp" alt="">

          <div class="right-side">
            <div class="contentlogo">
              <img src="../home/images/tv-show/poster/sex-education-logo.webp" alt="content logo" class="show-logo" />
            </div>
